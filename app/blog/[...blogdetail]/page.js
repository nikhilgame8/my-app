...
import NewsCard from "@/app/components/CardUI/NewsCard";
...
const page = () => {
  ...
  const shortNewsData = [0, 1, 2, 3, 0, 1, 2, 3];
  const people = [
    {
              ...
              <div>
                ...
                <div className="my-4">
                  <div className="text-base">
                    <p>
                      Qui incididunt est ullamco aliqua consectetur do aliquip
                      commodo sunt. Quis do ex aliquip occaecat cupidatat ipsum.
                      Minim anim ipsum incididunt Lorem veniam excepteur minim
                      labore aliquip fugiat. Cillum sit consectetur in non minim
                      sint sunt ullamco officia cupidatat sunt. Commodo
                      consequat aliqua incididunt veniam cupidatat. Enim quis
                      cillum nulla occaecat sint et ea consequat duis.
                    </p>
                    <br />
                    <p>
                      Qui incididunt est ullamco aliqua consectetur do aliquip
